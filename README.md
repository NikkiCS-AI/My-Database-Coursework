...
- **Database:** MySQL  
- **Local development environment:** [MAMP](https://www.mamp.info/) (or any similar Apache + MySQL setup)
...
3. Create a new MySQL database — for example: crm_db.
...
5. Copy the project folder into your MAMP htdocs (or your web root directory).

6. If required, update the database connection settings in the PHP configuration to match your MySQL credentials (username, password, database name).
